...
if __name__ == "__main__":
    ser = serial.Serial(
        "/dev/pts/4", 115200, timeout=2
    )  # for Pi Zero use '/dev/ttyAMA0' and for others use '/dev/ttyUSB0'.
    ser.flush()
...
engine = subprocess.Popen(
    "stockfish", universal_newlines=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE
)
...
def sendToScreen(line1, line2, line3, size="14"):
    ...
    screenScriptToRun = [
        "python3",
        "/home/king/SmartChess/RaspberryPiCode/printToOLED.py",
        "-a " + line1,
        "-b " + line2,
        "-c " + line3,
        "-s " + size,
...
if gameplayMode == "stockfish":
    ...
    updateScriptToRun = [
        "python3",
        "/home/king/SmartChess/RaspberryPiCode/update-online.py",
    ]
