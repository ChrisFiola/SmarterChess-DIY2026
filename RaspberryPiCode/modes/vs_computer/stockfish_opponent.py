    ...
    def _ensure_configured(self) -> None:
        ...
        try:
            if self.use_elo:
                ...
                print(
                    f"[ENGINE] configured Skill Level={level}",
                    file=sys.stderr,
                    flush=True,
                )
